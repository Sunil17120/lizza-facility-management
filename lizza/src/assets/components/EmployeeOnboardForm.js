...
const EmployeeOnboardForm = ({ locations, onCancel, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    submitData.append('personal_email', formData.email); 
      ...
      {(kycStatus === 'verified' || kycMode === 'without_aadhaar') && (
        <>
          <div className="text-center mb-4 mt-4">
            ...
            </div><p className="small text-muted mt-2">Applicant Photo <span className="text-danger">*</span></p>
          </div>
            ...
            <Tab eventKey="personal" title="Personal Info">
              ...
              <Row>
                <Col md={4} className="mb-3">
                    <Form.Label className="small fw-bold">First Name <span className="text-danger">*</span></Form.Label>
                    <Form.Control required value={formData.firstName} onChange={e => setFormData({...formData, firstName: e.target.value})} />
                </Col>
                <Col md={4} className="mb-3">
                    <Form.Label className="small fw-bold">Last Name <span className="text-danger">*</span></Form.Label>
                    <Form.Control required value={formData.lastName} onChange={e => setFormData({...formData, lastName: e.target.value})} />
                </Col>
                <Col md={4} className="mb-3">
                    <Form.Label className="small fw-bold">DOB <span className="text-danger">*</span></Form.Label>
                    <Form.Control type="date" required value={formData.dob} onChange={e => setFormData({...formData, dob: e.target.value})} />
                </Col>
                <Col md={4} className="mb-3">
                    <Form.Label className="small fw-bold">Primary Mobile No <span className="text-danger">*</span></Form.Label>
                    <Form.Control required type="tel" pattern="\d{10}" maxLength="10" minLength="10" title="Must be exactly 10 digits" value={formData.phoneNumber} onChange={e => setFormData({...formData, phoneNumber: e.target.value.replace(/\D/g, '')})} />
                </Col>
                <Col md={4} className="mb-3">
                    <Form.Label className="small fw-bold">Personal Email <span className="text-danger">*</span></Form.Label>
                    <Form.Control required type="email" value={formData.email} onChange={e => setFormData({...formData, email: e.target.value})} />
                </Col>
                <Col md={4} className="mb-3"><Form.Label className="small fw-bold text-muted">Gender</Form.Label><Form.Select value={formData.gender} onChange={e => setFormData({...formData, gender: e.target.value})}><option value="">Select</option><option value="Male">Male</option><option value="Female">Female</option><option value="Other">Other</option></Form.Select></Col>
                <Col md={4} className="mb-3"><Form.Label className="small fw-bold text-muted">Marital Status</Form.Label><Form.Select value={formData.maritalStatus} onChange={e => setFormData({...formData, maritalStatus: e.target.value})}><option value="">Select</option><option value="Single">Single</option><option value="Married">Married</option></Form.Select></Col>
                <Col md={4} className="mb-3"><Form.Label className="small fw-bold text-muted">Identity Mark</Form.Label><Form.Control value={formData.identityMark} onChange={e => setFormData({...formData, identityMark: e.target.value})} /></Col>
                <Col md={6} className="mb-3"><Form.Label className="small fw-bold text-muted">Father's Name</Form.Label><Form.Control value={formData.fatherName} onChange={e => setFormData({...formData, fatherName: e.target.value})} /></Col>
                <Col md={6} className="mb-3"><Form.Label className="small fw-bold text-muted">Mother's Name</Form.Label><Form.Control value={formData.motherName} onChange={e => setFormData({...formData, motherName: e.target.value})} /></Col>
              </Row>
              <h6 className="mt-4 fw-bold border-bottom pb-2 text-primary">Medical & Demographics</h6>
              <Row>
                <Col md={2} className="mb-3"><Form.Label className="small fw-bold text-muted">Height (cm)</Form.Label><Form.Control value={formData.height} onChange={e => setFormData({...formData, height: e.target.value})} /></Col>
                <Col md={2} className="mb-3"><Form.Label className="small fw-bold text-muted">Blood Group</Form.Label><Form.Control value={formData.bloodGroup} onChange={e => setFormData({...formData, bloodGroup: e.target.value})} /></Col>
                <Col md={2} className="mb-3"><Form.Label className="small fw-bold text-muted">Caste</Form.Label><Form.Control value={formData.caste} onChange={e => setFormData({...formData, caste: e.target.value})} /></Col>
                <Col md={2} className="mb-3"><Form.Label className="small fw-bold text-muted">Category</Form.Label><Form.Control value={formData.category} onChange={e => setFormData({...formData, category: e.target.value})} /></Col>
                <Col md={2} className="mb-3"><Form.Label className="small fw-bold text-muted">Religion</Form.Label><Form.Control value={formData.religion} onChange={e => setFormData({...formData, religion: e.target.value})} /></Col>
                <Col md={2} className="mb-3"><Form.Label className="small fw-bold text-muted">Nationality</Form.Label><Form.Control value={formData.nationality} onChange={e => setFormData({...formData, nationality: e.target.value})} /></Col>
                <Col md={12} className="mb-3"><Form.Label className="small fw-bold text-muted">Medical Remarks (If any)</Form.Label><Form.Control as="textarea" rows={1} value={formData.medicalRemarks} onChange={e => setFormData({...formData, medicalRemarks: e.target.value})} /></Col>
              </Row>
            </Tab>
            ...
            <Tab eventKey="address" title="Address">
              <Row className="mt-3">
                <Col md={6} className="mb-4">
                  ...
                  <Form.Group className="mb-2"><Form.Label className="small fw-bold text-muted">Address</Form.Label><Form.Control as="textarea" rows={2} value={formData.permAddress} onChange={e => setFormData({...formData, permAddress: e.target.value})} /></Form.Group>
                  <Form.Group className="mb-2"><Form.Label className="small fw-bold text-muted">State</Form.Label><Form.Control value={formData.permState} onChange={e => setFormData({...formData, permState: e.target.value})} /></Form.Group>
                  <Form.Group className="mb-2"><Form.Label className="small fw-bold text-muted">PIN</Form.Label><Form.Control value={formData.permPin} onChange={e => setFormData({...formData, permPin: e.target.value})} /></Form.Group>
                  <Form.Group className="mb-2"><Form.Label className="small fw-bold text-muted">Alt. Mobile No</Form.Label><Form.Control value={formData.permMobile} onChange={e => setFormData({...formData, permMobile: e.target.value})} /></Form.Group>
                </Col>
                <Col md={6} className="mb-4">
                  <h6 className="fw-bold border-bottom pb-2 text-primary">Temporary Address</h6>
                  <Form.Group className="mb-2"><Form.Label className="small fw-bold text-muted">Address</Form.Label><Form.Control as="textarea" rows={2} value={formData.tempAddress} onChange={e => setFormData({...formData, tempAddress: e.target.value})} /></Form.Group>
                  <Form.Group className="mb-2"><Form.Label className="small fw-bold text-muted">State</Form.Label><Form.Control value={formData.tempState} onChange={e => setFormData({...formData, tempState: e.target.value})} /></Form.Group>
                  <Form.Group className="mb-2"><Form.Label className="small fw-bold text-muted">PIN</Form.Label><Form.Control value={formData.tempPin} onChange={e => setFormData({...formData, tempPin: e.target.value})} /></Form.Group>
                  <Form.Group className="mb-2"><Form.Label className="small fw-bold text-muted">Local Mobile No</Form.Label><Form.Control value={formData.tempMobile} onChange={e => setFormData({...formData, tempMobile: e.target.value})} /></Form.Group>
                </Col>
              </Row>
            </Tab>

            <Tab eventKey="edu" title="Edu/Exp">
            ...
            <Tab eventKey="family" title="Family/Refs">
              ...
              <Row>
                <Col md={6} className="mb-3">
                    <Form.Label className="small fw-bold text-muted">Local Reference 1</Form.Label>
                ...
                <Col md={6} className="mb-3">
                    <Form.Label className="small fw-bold text-muted">Local Reference 2</Form.Label>
            ...
            <Tab eventKey="bank" title="Work & IDs">
              ...
              <Row className="mb-3">
                <Col md={4} className="mb-2">
                  <Form.Label className="small fw-bold">HR Designation <span className="text-danger">*</span></Form.Label>
                ...
                <Col md={4} className="mb-2">
                  <Form.Label className="small fw-bold text-muted">LFM ID NO <Lock size={12}/></Form.Label>
                  <Form.Control disabled placeholder="Auto Generated by Admin" />
                </Col>
              </Row>
              ...
              {(formData.userType === 'employee' || formData.userType === 'manager') && (
                <Row className="mb-3 p-3 bg-light rounded border border-secondary border-opacity-25">
                  <Col md={4} className="mb-2">
                    ...
                    <Form.Control value={formData.unitName} onChange={e => setFormData({...formData, unitName: e.target.value})} placeholder="e.g. Tech Park Tower A" />
                  </Col>
                  <Col md={4} className="mb-2">
                    <Form.Label className="small fw-bold text-muted">Shift Start Time</Form.Label>
                    <Form.Control type="time" value={formData.shiftStart} onChange={e => setFormData({...formData, shiftStart: e.target.value})} />
                  </Col>
                  <Col md={4} className="mb-2">
                    <Form.Label className="small fw-bold text-muted">Shift End Time</Form.Label>
                    <Form.Control type="time" value={formData.shiftEnd} onChange={e => setFormData({...formData, shiftEnd: e.target.value})} />
                  </Col>
                </Row>
              )}
              ...
              <Row className="mb-3">
                <Col md={4} className="mb-3"><Form.Label className="small fw-bold text-muted">Bank Name</Form.Label><Form.Control value={formData.bankName} onChange={e => setFormData({...formData, bankName: e.target.value})} /></Col>
                <Col md={4} className="mb-3"><Form.Label className="small fw-bold text-muted">Account Number</Form.Label><Form.Control type="password" value={formData.accountNumber} onChange={e => setFormData({...formData, accountNumber: e.target.value})} /></Col>
                <Col md={4} className="mb-3"><Form.Label className="small fw-bold text-muted">IFSC Code</Form.Label><Form.Control value={formData.ifscCode} onChange={e => setFormData({...formData, ifscCode: e.target.value})} /></Col>
                <Col md={12}>
              ...
              <Row>
                <Col md={12} className="mb-3 mt-2">
                  <Form.Label className="small fw-bold d-flex align-items-center">UID (Gov ID) {kycMode === 'without_aadhaar' ? <span className="text-danger ms-1">*</span> : <Lock size={14} className="ms-2 text-primary" />}</Form.Label>
                  <Form.Control 
                    required={kycMode === 'without_aadhaar'} 
                    pattern="\d{12}" maxLength="12" minLength="12" title="Aadhaar must be exactly 12 digits"
                    value={formData.aadhar} 
                    onChange={e => setFormData({...formData, aadhar: e.target.value.replace(/\D/g, '')})} 
                    placeholder={kycMode !== 'without_aadhaar' ? "[Fetched automatically from e-KYC]" : "Enter 12-digit ID Number"} 
                ...
                <Col md={12} className="mb-4">
                   <Card className="border-warning bg-light">
                     <Card.Body className="py-2">
                       <Form.Label className="small fw-bold">Upload Gov ID Copy (Front & Back) <span className="text-danger">*</span></Form.Label>
                ...
                <Col md={6} className="mb-4">
                    <Form.Label className="small fw-bold text-muted">PAN Card Number</Form.Label>
          ...
          {kycMode === 'without_aadhaar' && (
             <Card className="border-danger mb-4">
                ...
                <Card.Body>
                   ...
                   <Row>
                     <Col md={6} className="mb-3"><Form.Label className="fw-bold small text-danger">LEFT Hand Impressions *</Form.Label><Form.Control type="file" accept="image/*,.pdf" required onChange={(e) => handleFileChange(e, 'fingerprintsLeft')} /></Col>
                     <Col md={6} className="mb-3"><Form.Label className="fw-bold small text-danger">RIGHT Hand Impressions *</Form.Label><Form.Control type="file" accept="image/*,.pdf" required onChange={(e) => handleFileChange(e, 'fingerprintsRight')} /></Col>
                   </Row>
                </Card.Body>
             </Card>
          )}
