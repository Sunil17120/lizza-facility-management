...
class User(Base):
    ...
    kyc_mode = Column(String, default="aadhaar_xml") # aadhaar_xml, aadhaar_qr, without_aadhaar
    ...
    blockchain_id = Column(String, unique=True, nullable=True) # THIS IS YOUR LFM ID (Generated by Admin later)
    
    # 5. Professional Details
    designation = Column(String, nullable=True)
    department = Column(String, nullable=True)
    
    # 6. Sensitive Data (ALL ENCRYPTED AND OPTIONAL)
    ...
    # 7. Document Paths (Base64 or Cloud URLs)
    profile_photo_path = Column(Text, nullable=True)
    id_proof_path = Column(Text, nullable=True)
